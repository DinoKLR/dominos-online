...
export default function Home() {
  const [gameMode, setGameMode] = useState<'lobby' | 'washing' | 'game' | 'proper'>('lobby')
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center max-w-3xl mx-auto">
            <button
              ...
              className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-400 hover:to-orange-400 text-black px-8 py-4 rounded-xl font-bold text-xl transition-all transform hover:scale-105 shadow-lg shadow-yellow-500/50 border-4 border-yellow-300"
            >
              ⭐ BEST - PROPER VERSION ⭐
            </button>
            <button
              onClick={() => setGameMode('game')}
              className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-400 hover:to-pink-400 text-black px-8 py-4 rounded-xl font-bold text-xl transition-all transform hover:scale-105 shadow-lg shadow-purple-500/50 border border-purple-400"
            >
              🥷 Fight Computer Ninja
            </button>
            <button
              onClick={() => setGameMode('washing')}
              className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-black px-8 py-4 rounded-xl font-bold text-xl transition-all transform hover:scale-105 shadow-lg shadow-cyan-500/50 border border-cyan-400"
            >
              Try Ninja Washing
            </button>
          </div>
